<div
    class="flex justify-between items-center space-x-4 fixed top-0 left-0 right-0 z-50 mx-auto max-w-sm p-4 bg-slate-100"
>
    <div class="w-8/12">
    ...
    >
        ...
        <div class="p-2 bg-sky-50 rounded-full">
            <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="currentColor"
